...
open class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    fileprivate func processRequest(request: DataRequest, _ managerId: String, _ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
        ...
        switch T.self {
        case is String.Type:
            validatedRequest.responseString(queue: RickAndMortyApiClientAPI.apiResponseQueue, completionHandler: { (stringResponse) in
                cleanupRequest()
        ...
        case is URL.Type:
            validatedRequest.responseData(queue: RickAndMortyApiClientAPI.apiResponseQueue, completionHandler: { (dataResponse) in
                cleanupRequest()
        ...
        case is Void.Type:
            validatedRequest.responseData(queue: RickAndMortyApiClientAPI.apiResponseQueue, completionHandler: { (voidResponse) in
                cleanupRequest()
...
open class AlamofireDecodableRequestBuilder<T:Decodable>: AlamofireRequestBuilder<T> {
    ...
    override fileprivate func processRequest(request: DataRequest, _ managerId: String, _ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
        ...
        default:
            validatedRequest.responseData(queue: RickAndMortyApiClientAPI.apiResponseQueue, completionHandler: { (dataResponse: DataResponse<Data>) in
                cleanupRequest()
